...
public class Problem2 {
    ...
    static void getTotal(double[] arr){
        ...
        for (double num : arr) {  // for loop that iterates over each number in the array and adds it to the variable 'total'
            total += num;
        }
        //set the double to a string variable
        //TODO ensure rounding is to two decimal places (i.e., 0.10, 0.01, 1.00)
        total = Math.round(total * 100.0) / 100.0;  // rounds total to two decimal places
        totalOutput = total+"";
